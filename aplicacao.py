...
core = backend.TransactionObject()
...
def insert_command():
    rows = core.insert(app.txtNome.get(), app.txtSobrenome.get(), app.txtEmail.get(), app.txtCPF.get())
    for r in rows:
        app.listClientes.insert(END, r)
...
if __name__ == "__main__":
    ...
    app.btnUptade.configure(command=update_command)
